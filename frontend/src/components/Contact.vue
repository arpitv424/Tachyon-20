    ...
    <div class="contactForm">
      ...
      <div class="col-sm-12 col-md-5 ts-contact">
        <div>
          ...
          <div class="c2">MPCJUET</div>
          <div class="c3"><a href="tel:+91 8447140370">+91 8447140370</a></div>
          <div class="c4"><a href="mailto:admin@mpcjuet.tech">admin@mpcjuet.tech</a></div>
        </div>
      </div>
...
export default {
  ...
  methods:{
    recordMessage:()=>{
      ...
      .catch(err=>{
        console.log(err);
        alert("Write us at admin@mpcjuet.tech");
      })
